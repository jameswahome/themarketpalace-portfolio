  ...
  return (
    <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                <a className="hover:opacity-75"> React </a>
                <a className="hover:opacity-75"> React Native </a>
                <a className="hover:opacity-75"> MongoDB </a>
                <a className="hover:opacity-75"> Graphql </a>
                <a className="hover:opacity-75"> NextJs</a>
              </nav>
            </div>
            <div>
        ...
        <p className="mt-8 text-xs text-gray-800">© 2022 TheMarketPalace</p>
      </div>
    </footer>
  );
};
